...
function createBot() {
    const bot = mineflayer.createBot({
        host: 'VillaInmigrantes.aternos.me', // <--- REEMPLAZA ESTO POR LA IP DE TU SERVER
        port: 47568,                // Puerto predeterminado de Minecraft
        username: 'BOT_67',    // Nombre genérico del bot/NPC dentro del juego
